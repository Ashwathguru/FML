...
sc=StandardScaler() #Linear regression takes cae of this must define explicitly for KNN,DT
...
classifier = DecisionTreeClassifier(criterion='entropy',random_state=0) #entropy and information gain
